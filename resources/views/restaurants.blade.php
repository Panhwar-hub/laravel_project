            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-10">
                    <div class="banner-content text-center">
                        ...
                        {{-- <h1 class="banner-content__heading bg-line">Restaurants</h1> --}}
            ...
            <div class='row'>
                                ...
                                <li class="sponsore-content-list__single">
                                    ...
                                    <div class="sponsore-details">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-sm-row flex-column">
                                            ...
                                            <a href="{{ route('product-detail', $item->slug) }}" class="themeBtn m-sm-0 mt-3">View
                                                Detail</a>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class='col-lg-2'>
                    <div class="location-map">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387190.2798864718!2d-74.25986673512958!3d40.69767006847737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2s!4v1678143091027!5m2!1sen!2s"
    ...
    <script type="text/javascript">
        (() => {
            ...
            $(".suggested").click(function() {
                window.location.href = "{{ route('restaurants') }}/suggestion/"+$(this).val();
            })

            $(".features").click(function() {
                window.location.href = "{{ route('restaurants') }}/feature/"+$(this).val();
            })
            
            $(".address").click(function() {
                window.location.href = "{{ route('restaurants') }}/address/"+$(this).val();
            })
        })()
    </script>
@endsection
