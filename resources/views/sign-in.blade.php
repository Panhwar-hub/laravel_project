...
@section('content')
<!--<section class="breadcumb" style="background-image: url({{asset('images/pg-banner.png')}});">-->
<!--    <div class="container">-->
<!--        <div class="breadcumb-con">-->
<!--            <?php // App\Helpers\Helper::inlineEditable("h2",["class"=>""],'login','LOGINzTXT2');?>-->
<!--        </div>-->
<!--    </div>-->
<!--</section>-->
<!--<div class="banner">-->
...
<!--                    <h1 class="banner-content__heading bg-line">Sign IN</h1>-->
    ...
    <div class='container-fluid px-5'>
        <div class='row'>
            ...
            <div class="col-12 col-lg-12 wow bounceInRight">
                <form method="POST" action="{{route('sign-in-submit')}}" class="contact-form">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="contact-form__fields">
                                <button type="submit" class="themeBtn themeBtn--full">Sign In</button>
                            </div>
                        </div>
                    </div>
                </form>
