                ...
                <div class="sponsore-content">
                    <div class="sponsore-content__header">
                        <div>
                            ...
                            <div class="heading"><?php echo html_entity_decode($slider->headings); ?></div>
                    ...
                    <ul class="sponsore-content-list">
                        ...
                        <li class="sponsore-content-list__single">
                            ...
                            <div class="sponsore-details">
                                ...
                                <div class="close-time"><span class="color-primary">{{ $item->status==1?'Opened':'Closed' }}</span> until {{ $item->end_time }} </div>
                                <ul class="perks">
                                    {{--
                                    <li>
                                        <a href="#">
                                ...
                                <div class="d-flex align-items-center justify-content-between  flex-sm-row flex-column">
                                    ...
                                    <a href="{{ route('product-detail', $item->slug) }}" class="themeBtn   m-sm-0 mt-3">View Website</a>
                                </div>
                            </div>
                        </li>
                        @endforeach
...
<script type="text/javascript">
        (() => {
            ...
            $(".suggested").click(function() {
                window.location.href = "{{ route('lifestyle') }}/suggestion/"+$(this).val();
            })

            $(".features").click(function() {
                window.location.href = "{{ route('lifestyle') }}/feature/"+$(this).val();
            })
            
            $(".address").click(function() {
                window.location.href = "{{ route('lifestyle') }}/address/"+$(this).val();
            })
        })()
</script>
@endsection
