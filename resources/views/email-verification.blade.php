        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-lg-10">
                <div class="banner-content text-center">
                    <h1 class="banner-content__heading bg-line">Email Verification</h1>
                    ...
                    <div class="login-form">
                        <div class="title">
                            ...
                            <div class="col-12 col-lg-12 wow bounceInRight">
                                <form method="POST" action="{{route('email-vefify')}}" class="contact-form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="contact-form__fields">
                                                @if(!isset($user_id))
                                                    ...
                                                    <input type="email" id="email" required name="email" value="{{old('email')}}" placeholder="Your Email">
                                                    @if ($errors->has('email'))
                                        ...
                                        <div class="col-12">
                                            <div class="contact-form__fields">
                                                ...
                                                <input type="text" id="verification" required name="verification" placeholder="Verification Code">
                                                @if ($errors->has('verification'))
                                                    <span class="text-danger">{{ $errors->first('verification') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="contact-form__fields">
                                                <button type="submit" class="themeBtn themeBtn--full">Verification</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
