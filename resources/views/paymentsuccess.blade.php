                            ...
                            <tr>
                                <td style="font-size:13px; line-height:22px; padding:0 15px; margin-bottom:15px;">
                                    <strong>
                                        ...
                                        We have received your payment againtst order number # {{ $orders->id }} your
                                        order amount is ${{ $orders->total_amount }} Thank you for shopping.
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    ...
                                    To make sure our emails reach your inbox, please add <a
                                        href="mailto:{{ $config['EXTERNALEMAIL'] }}">{{ $config['EXTERNALEMAIL'] }}</a>
                                    to
                                    your safe
