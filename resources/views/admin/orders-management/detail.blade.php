                ...
                <div class="invoice">
                        ...
                        <table id="user-table" class="table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @if(!empty($orders->shipping_fee) && $orders->shipping_fee != 0)
                                    <tr>
                                <td></td>
                                 
                                 
                                    <td class="text-right" colspan="3"><h6>Delivery Method : ({{ $orders->service_type }})</h6></td>
                                    <td>Shipping Fee : $ {{$orders->shipping_fee}}</td>
                                ...
                                <td></td>
                                    ...
                                    <td class="text-right" colspan="3"><h6>Delivery Method</h6></td>
