...
<div class="main-sec">
      <div class="main-wrapper">
        ...
        <form action="{{route('admin.create_category')}}" method="POST" enctype="multipart/form-data" class="main-form create_user_form">
            @csrf
              ...
              <div class="form-group">
                ...
                <ul class="list-inline">
                  <li class="list-inline-item">
                    <div class="checkbox">
                      <input type="radio" id="user1" name="is_menu"  value="1">
                      <label for="user1">Yes</label>
                    </div>
                  </li>
                  <li class="list-inline-item">
                    <div class="checkbox">
                      <input type="radio" id="user2" name="is_menu" value="0" checked>
