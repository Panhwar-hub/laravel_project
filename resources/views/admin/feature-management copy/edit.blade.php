                ...
                <form id="add-record-form" class="main-form mc-b-3">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-md-4 col-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="{{ $feature->name }}" required
                                    class="form-control" placeholder="Enter feature Name">
                                @if ($errors->has('name'))
                        ...
                        <div class="col-lg-4 col-md-4 col-4">
                            <div class="form-group">
                                <label>Slug*:</label>
                                <input type="text" name="slug" id="slug" value="{{ $feature->slug }}" required
                        ...
                        <div class="col-lg-4 col-md-4 col-4">
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control cat-dd" required>
                                    ...
                                    @foreach ($cat as $c)
                                        <option {{ $feature->category_id == $c->id ? 'selected' : '' }}
