                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="posted_by" class="form-control" value="{{$welcome_slider->headings}}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ckeditor" id="editor2"
                                        placeholder="Enter Long Description">{{$welcome_slider->long_desc}}</textarea>
...
(()=>{
    ...
    $( "#add-record" ).click(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:'{{route('admin.updatewelcomeSlider')}}',
            data:data,
