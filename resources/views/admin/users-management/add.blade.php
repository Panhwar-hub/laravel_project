            ...
            <div class="col-lg-6 col-md-6 col-12">
              <div class="form-group">
                ...
                <div class="relative-div">
                  ...
                  <a href="javascript:void(0)" class="hidePassword"> <i class="fa fa-eye "></i></a>
                </div>
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
              <div class="form-group">
                ...
                <div class="relative-div">
                  <input type="password" name="password_confirmation"  class="form-control password" placeholder="Enter Confirm Password">
                  <a href="javascript:void(0)" class="show-password-btn"><i class="fa fa-eye-slash "></i> </a>
                  <a href="javascript:void(0)" class="hidePassword"> <i class="fa fa-eye "></i></a>
                </div>
              </div>
