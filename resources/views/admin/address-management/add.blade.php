                ...
                <div class="row align-items-center mc-b-3">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="primary-heading color-dark">
                            <h2>Add Neighborhood Address</h2>
                        </div>
                    </div>
                    ...
                    <form id="add-record-form" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    <label>Slug*:</label>
                                    <input type="text" name="slug"  readonly id="slug" required class="form-control" placeholder="Enter Slug">
                                </div>
                            </div>
...
(()=>{
    ...
    $( "#add-record" ).click(function(e) {
        ...
        $.ajax({
            type:'POST',
            url:'{{route('admin.create_address')}}',
            data:data,
            ...
            success:function(data) {
                ...
                if(data.status == 1){
                    ...
                    setInterval(() => {
                         window.location.href = "{{route('admin.address_listing')}}";
                    }, 2500);
                }
                if(data.status == 2){
                    $.toast({
