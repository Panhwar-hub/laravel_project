            ...
            <table id="user-table" class="table table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>{{$admin->name}}</td>
                    <td>{{$admin->email}}</td>
                    <td>{{($admin->type == 1) ? 'Super Admin' :'Listing Manager' }}</td>
                    ...
                    <div class="dropdown show action-dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="action-dropdown">
                        ...
                        <a class="dropdown-item" href="{{route('admin.edit_admin',$admin->id)}}"><i class="fa fa-pencil-square-o"
                            aria-hidden="true"></i>
                          Edit</a>
                        @if(Auth::guard('admin')->user()->type == 2 && Auth::guard('admin')->user()->id == $admin->id)
                        <a class="dropdown-item" href="{{route('admin.delete_admin',$admin->id)}}"><i class="fa fa-ban"
                            aria-hidden="true"></i>
                          Delete</a>
                        @elseif(Auth::guard('admin')->user()->type == 1 && Auth::guard('admin')->user()->id != $admin->id)
                        <a class="dropdown-item" href="{{route('admin.delete_admin',$admin->id)}}"><i class="fa fa-ban"
                            aria-hidden="true"></i>
                          Delete</a>
                        @endif
