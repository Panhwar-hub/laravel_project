                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="created_by" id="created_by" value="{{old('created_by')}}" required class="form-control" placeholder="Enter Created By">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ckeditor" id="editor1"  placeholder="Enter Short Description">{{$blog->short_desc}}</textarea>
                            ...
                            <!--        <textarea rows="5" class="form-control ckeditor" id="editor2"  placeholder="Enter Long Description">{{$blog->long_desc}}</textarea>-->
