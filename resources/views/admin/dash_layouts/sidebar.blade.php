      ...
      <div class="side-bar-links">
        <ul class="navigation-list">
          ...
          <li class="{{isset($user_menu)?'active':''}}"><a href="{{route('admin.dashboard')}}">
            ...
            {{-- <li class="{{ isset($brand_menu)?'active':'' }}"><a href="{{ route('admin.brand_listing') }}">
              <figure class="mb-0"><img src="{{ asset('admin/images/side-link-1.svg') }}" alt="side-links-img"></figure> Brand Management
            </a></li> --}}
            ...
            <li class="li-dropdown">
                <a href="javascript:void(0)">
                    <figure class="mb-0"><img src="{{asset('admin/images/side-link-2.svg')}}" alt="side-links-img"></figure> Inventory Management
                </a>
                <div class="dropdown-content">
                    <ul>
                        <li><a href="{{route('admin.category_listing')}}">Category Management</a></li>
                        <li><a href="{{route('admin.products_listing')}}">Products Management</a></li>
                        <li><a href="{{route('admin.type_listing')}}">Type Management</a></li>
                        <li><a href="{{route('admin.feature_listing')}}">Feature Management</a></li>
                        <li><a href="{{route('admin.address_listing')}}">Neighborhood Management</a></li>
                    </ul>
                </div>
            </li>
          ...
          <li><a href="{{route('admin.inquiries_listing')}}">
            ...
            <!-- <li><a href="{{route('admin.refund_listing')}}" class="{{isset($refund_menu)?'active':''}}">
              <figure class="mb-0"><img src="{{  asset('admin/images/side-link-7.svg')}}" alt="side-links-img"></figure> Refund Management
            </a></li>

            <li><a href="{{route('admin.return_listing')}}" class="{{isset($return_menu)?'active':''}}">
              <figure class="mb-0"><img src="{{  asset('admin/images/side-link-7.svg')}}" alt="side-links-img"></figure> Return Management
            </a></li>
            
            <li><a href="{{route('admin.cancelorder_listing')}}" class="{{isset($ordercancel_menu)?'active':''}}">
              <figure class="mb-0"><img src="{{  asset('admin/images/side-link-7.svg')}}" alt="side-links-img"></figure> Order Cancel Management
            </a></li> -->
          ...
          <li class="li-dropdown"><a href="javascript:void(0)">
            ...
            <ul>
                ...
                <li><a href="{{route('admin.welcomeSlider')}}">Welcome Slider Management</a></li>
                <li><a href="{{route('admin.homeSlider')}}">Banners Management</a></li> 
                <li><a href="{{route('admin.admin_listing')}}">Admin Management</a></li>
            </ul>
            </div>
        </li>
