    ...
    /*in page css here*/
            $(".suggested").click(function() {
                window.location.href = "{{ route('art-and-museums') }}/suggestion/"+$(this).val();
            })

            $(".features").click(function() {
                window.location.href = "{{ route('art-and-museums') }}/feature/"+$(this).val();
            })
            
            $(".address").click(function() {
                window.location.href = "{{ route('art-and-museums') }}/address/"+$(this).val();
            })
    })()
    </script>
    @endsection
